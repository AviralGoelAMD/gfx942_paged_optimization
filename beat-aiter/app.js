...
function stageMapSection(d, ps, ours, aiter) {
  ...
  <section>
    ...
    <div class="map reveal">
      ...
      <p>CK DSL &middot; dense paged+SW</p>
...
function calloutSection(ps) {
  ...
  <section>
    ...
    <p class="lede">This dashboard reports what was actually measured, not a flattering subset. ours is the
    dense-paged-SW kernel timed kernel-bound (<code>time_launches</code>); AITER + the prod 4-warp via
    <code>sw_paged_bench.py</code>, all same-node and correctness-gated vs fp32 windowed SDPA before timing.</p>
    <div class="callout reveal">
